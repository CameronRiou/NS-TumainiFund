...
export class MyListSelectorComponent implements OnInit {
    ...
    private _parish_workerEditModel: ParishWorker;
    ...
    ngOnInit(): void {
        ...
        this._pageRoute.activatedRoute
            ...
            .forEach((params) => {
                parish_workerId = params.id;
            });

        this._parish_workerEditModel = this._parish_workerEditService.getEditableParishWorkerById(parish_workerId);
    }

    onSelectorTap(): void {
        const title = `Select Parish Worker ${capitalizeFirstLetter(this.tag)}`;
