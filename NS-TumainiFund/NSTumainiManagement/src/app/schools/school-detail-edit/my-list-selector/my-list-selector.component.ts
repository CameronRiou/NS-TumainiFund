...
export class MyListSelectorComponent implements OnInit {
    ...
    private _schoolEditModel: School;
    ...
    ngOnInit(): void {
        ...
        this._schoolEditModel = this._schoolEditService.getEditableSchoolById(schoolId);
    }

    onSelectorTap(): void {
        const title = `Select School ${capitalizeFirstLetter(this.tag)}`;
